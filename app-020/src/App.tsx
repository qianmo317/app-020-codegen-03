...
import { DrillEditorPage } from './pages/DrillEditor';
...
export function App() {
  ...
  else if (seg0 === 'drill' && seg1) content = <DrillEditorPage drillId={seg1} />;
  else if (seg0 === 'drills') content = <DrillsPage key={seg1 ?? 'all'} buildingId={seg1} />;

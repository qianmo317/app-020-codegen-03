...
import { DrillDetailPage } from './pages/DrillDetail';
...
export function App() {
  ...
  else if (seg0 === 'drills') content = <DrillsPage buildingId={seg1} />;
  else if (seg0 === 'drill' && seg1) content = <DrillDetailPage drillId={seg1} />;
